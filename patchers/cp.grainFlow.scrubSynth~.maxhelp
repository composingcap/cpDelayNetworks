...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "Create a wavetable like synthisizer through granular synthisis "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.25, 10.0, 430.0, 45.0 ],
					"text" : "cp.grainFlow.scrubSynth~ "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.5, 201.0, 150.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.5, 138.0, 150.0, 32.0 ],
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 48.75, 282.0, 47.0, 21.0 ],
					"text" : "sig~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 11.0, 247.0, 50.0, 21.0 ],
					"text" : "sig~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 211.0, 417.0, 315.0, 86.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 116.25, 282.0, 38.0, 21.0 ],
					"text" : "sig~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 211.0, 329.0, 53.0, 21.0 ],
					"text" : "sig~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 87.0, 227.0, 47.0, 21.0 ],
					"text" : "sig~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 329.0, 45.0, 21.0 ],
					"text" : "state $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 462.0, 33.0, 21.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 407.0, 82.0, 21.0 ],
					"text" : "mc.mixdown~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 368.0, 166.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 15.0, 364.0, 215.0, 21.0 ],
					"text" : "cp.grainFlow.scrubSynth~ _scrubSynthHelp 6"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cp.grainFlow.scrubSynth~.maxpat",
