...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 369.0, 53.0, 21.0 ],
					"text" : "freeze $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 629.0, 173.0, 57.0, 21.0 ],
					"text" : "writeagain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.0, 169.0, 60.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.0, 200.0, 127.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.0, 108.0, 100.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 138.0, 739.0, 541.0, 167.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 295.0, 32.0, 21.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 64.0, 1036.0, 143.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 1074.0, 49.0, 21.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 64.0, 908.0, 364.0, 117.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 138.0, 128.0, 393.0, 442.0 ],
					"varname" : "cp.grainFlow.Gui",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 64.0, 646.0, 93.0, 21.0 ],
					"text" : "cp.grainFlow.live~"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6::obj-66" : [ "direction", "direction", 0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/cpDelayNetworks/data",
